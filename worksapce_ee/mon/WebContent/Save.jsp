...
<script> function addUser(id){
	var url="Save.jsp?id="+id;
...
<body>
	...
	String job=request.getParameter("job");
			...
			try {
				...
				String sql = "INSERT INTO EMPLOYEES(EMPLOYEE_ID, EMAIL, FIRST_NAME, LAST_NAME, PHONE_NUMBER,JOB_ID, HIRE_DATE) VALUES(?,?,?,?,?,?,SYSDATE)";
